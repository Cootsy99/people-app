...
class CitizenshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citizenship" do
    assert_difference("Citizenship.count") do
      post citizenships_url, params: { citizenship: { country_id: @citizenship.country_id, person_id: @citizenship.person_id } }
    end
  ...
  test "should update citizenship" do
    patch citizenship_url(@citizenship), params: { citizenship: { country_id: @citizenship.country_id, person_id: @citizenship.person_id } }
